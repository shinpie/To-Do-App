...
let db 
async function go()  {
    let mongodburi = 'mongodb://root:root@localhost:27017/To-DoApp?&authSource=admin' //mongodburi
...
function passwordProtected(req, res, next) {
    ...
    if (req.headers.authorization == "Basic dGVzdDp0ZXN0") {
        ...
        res.status(401).send("Authentication required, Password and username are both:- test")
    }
}
